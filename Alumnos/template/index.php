...
<?php include ('/xampp/htdocs/Alumnos/template/header.php'); ?>
            ...
            <div class="card">
                ...
                <form class="p-4" method="POST" action="registrar.php">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" accept="application/pdf" class="form-control" name="txtDocumento"  autofocus required>
                    </div>
                    <div class="d-grid">
...
<?php include ('/xampp/htdocs/Alumnos/template/footer.php') ?>